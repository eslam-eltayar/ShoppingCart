...
namespace MyShop.DataAccess.Data.Migrations
{
    ...
    [Migration("20240819142924_Fix02SetDiscriminatoratAppUser")]
    partial class Fix02SetDiscriminatoratAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyShop.Entities.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyShop.Entities.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyShop.Entities.Models.OrderHeader", b =>
                {
                    b.HasOne("MyShop.Entities.Models.AppUser", "AppUser")
                        .WithMany()
